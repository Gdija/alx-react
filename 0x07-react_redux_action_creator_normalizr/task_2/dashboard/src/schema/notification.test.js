...
describe('get notification for a given id', () => { 
    test('returns the correct notifications for the given user ID', () => {
        ...
        const notif = getAllNotificationsByUser(userId)
        expect(notif).toEqual(expect.arrayContaining(expectedNotif));
    });
});

describe("normalizes data", () => {
    test("verify that normalized data has a correct result array", () => {
        const expectedData = [ 
